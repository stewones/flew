                ...
                switch (_a.label) {
                    case 0:
                        procs = config.options.commands.map(function (c) {
                            return _this.createProcess(c.command, config.options.readyWhen).then(function (result) { return ({
                                result: result,
                                command: c.command
                            }); });
                        });
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this.createProcess(c.command, config.options.readyWhen)];
                                    case 2:
                                        success = _a.sent();

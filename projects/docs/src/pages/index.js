...
const features = [
  {
    content: (
      <p>
        Rebased helps you write apps that <strong>behave consistently</strong>,
  ...
  },
  {
    content: (
      <p>
        Rebased State relies on the Redux DevTools making it easy to trace{' '}
  ...
  },
  {
    content: (
      <p>
        ...
        <strong>7k (gzipped)</strong>. Add another features like{' '}
        <strong>cache, state, firebase or parse</strong> on demand.
      </p>
    ),
    image: (
      <svg
